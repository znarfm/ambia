  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden opacity-20 saturate-150 select-none dark:opacity-40">
      <div className="absolute inset-0 transform-gpu [backface-visibility:hidden]">
        <div
          className={`animate-float-slow absolute -top-[10%] -left-[10%] h-[40%] w-[40%] scale-[2] transform-gpu rounded-full blur-[30px] will-change-transform md:blur-[50px] ${colors[0]}`}
          style={{ animationDelay: "0s" }}
        ></div>
        <div
          className={`animate-float-slow absolute -right-[10%] -bottom-[10%] h-[35%] w-[35%] scale-[2] transform-gpu rounded-full blur-[25px] will-change-transform md:blur-[45px] ${colors[1] || colors[0]}`}
