   ...
   return (
     <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden opacity-20 saturate-150 select-none dark:opacity-40">
       <div className="absolute inset-0 transform-gpu [backface-visibility:hidden]">
         <div
           className={`animate-float-slow absolute -top-[10%] -left-[10%] h-[80%] w-[80%] transform-gpu rounded-full blur-[60px] md:blur-[100px] will-change-transform ${colors[0]}`}
           style={{ animationDelay: "0s" }}
         ></div>
         <div
           className={`animate-float-slow absolute -right-[10%] -bottom-[10%] h-[70%] w-[70%] transform-gpu rounded-full blur-[50px] md:blur-[90px] will-change-transform ${colors[1] || colors[0]}`}
     ...
     (
       ...
       return (
         <section
           ref={ref}
           id={id}
           className={`snap-section w-full pt-16 noise-${id} ${bgClass}`}
         >
